    ...
    <div className="space-y-16">
      ...
      <div className="space-y-6">
        ...
        <p className="text-xl text-slate-500 dark:text-slate-400 max-w-4xl leading-relaxed font-light">
          My academic journey focuses on building strong foundations in computer
          science while exploring how technical systems translate into real-world
          applications. I approach coursework as a framework for developing
          problem-solving intuition, systems thinking, and long-term technical
          depth.
        </p>
      </div>
