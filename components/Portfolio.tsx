      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div className="space-y-4">
            <div className="flex items-center space-x-4">
                ...
                <h2 className="text-4xl md:text-5xl font-extrabold text-[#1e293b] dark:text-white">Selected Engineering Projects</h2>
            </div>
        </div>
      </div>
      ...
      <div className="grid gap-10">
        {PROJECTS.map((project) => (
          <div 
            ...
            `}
          >
            {/* Background Blob on Hover (Matches WhatIDo style) */}
            ...
            <div className="flex flex-col lg:flex-row gap-10 items-start relative z-10">
              ...
              <div className="shrink-0 relative">
                <div className={`
                    ...
                    rounded-[2rem] flex items-center justify-center border border-slate-100 dark:border-slate-700 
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {project.tags.map(tag => (
                      <span key={tag} className="px-3 py-1 bg-white dark:bg-slate-800/50 border border-slate-100 dark:border-slate-700 rounded-lg text-xs font-medium text-slate-500 dark:text-slate-400">
                        {tag}
                      </span>
                    ))}
                  </div>
